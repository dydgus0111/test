...
app = Flask(__name__)
slack_token = "xoxb-507771103232-508404287827-eHwgiC9rQzkZX6dYZSGmhdT4"
slack_client_id = "507771103232.508508507554"
slack_client_secret = "d7fc059912a56ea9fd9e7d1a3ff10da2"
slack_verification = "ijXnSJGpxgDKrrPbfKl9MEBP"
...
def _crawl_naver_keywords(text):
    ...
    #################################################################################################################
        ...
        return "@챗봇이름 잉글랜드 /@챗봇이름 독일/@챗봇이름 스페인"
    else:
